...
public class FalseAnswerAdapter extends RecyclerView.Adapter<FalseAnswerAdapter.MyViewHolder> {

    Context context;
    private static List<TrueFalseAnswerPost> trueFalseAnswerPostList;
    private TextToSpeech t1;

    public FalseAnswerAdapter(Context context, List<TrueFalseAnswerPost> trueFalseAnswerPostList, TextToSpeech t1) {
